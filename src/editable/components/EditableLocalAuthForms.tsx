...
const inputClass = 'h-[3.35rem] rounded-2xl border border-[var(--slot4-border)] bg-white px-4 text-base font-bold text-[#090821] outline-none transition placeholder:text-[#7b8499] focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.35rem] items-center justify-center rounded-2xl bg-[var(--slot4-accent)] px-6 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#0c0a24] disabled:opacity-60'
